 ...
 <div class="row">
    ...
    <div class="row">
      <div class="col-25">
        ...
        <div class="col-75">
        <input type="text" id="Transaction ID" name="Transaction ID" placeholder="Enter Transaction ID">
      </div>
    </div>
 <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="text" id="Transaction password" name="Transaction password" placeholder="Enter Password">
      </div>
    </div>
    <div class="row">
